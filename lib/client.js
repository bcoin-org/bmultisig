...
class MultisigClient extends WalletClient {
  ...
  constructor(options) {
    ...
    this.path = MULTISIG_PREFIX;
    this.rootPath = ROOT_PREFIX;
    this.multisigPath = MULTISIG_PREFIX;
  ...
  fromOptions(options) {
    ...
    if (options.path != null) {
      enforce(typeof options.path === 'string', 'path', 'string');
      this.rootPath = options.path;
      this.multisigPath = this.rootPath + MULTISIG_PREFIX;
