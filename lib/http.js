...
class MultisigHTTP extends Server {
  ...
  initRouter() {
    ...
    this.get('/:id', async (req, res) => {
      ...
      res.json(200, req.mswallet.toJSON(false, balance, stats));
    });
    ...
    this.put('/:id', async (req, res) => {
      ...
      res.json(200, mswallet.toJSON(false, null, stats, 0));
    });
    ...
    this.put('/:id/locked/:hash/:index', async (req, res) => {
      ...
      // TODO: Change how we parse hash when we update bcoin.
    ...
    this.post('/:id/join', async (req, res) => {
      ...
      res.json(200, joined.toJSON(false, null, null, cosignerIndex));
    });
    ...
    this.post('/:id/proposal/:pid/force-reject', async (req, res) => {
      if (!req.admin) {
        res.json(403);
        return;
      }
    ...
    this.get('/:id/proposal/coin/:hash/:index', async (req, res) => {
      ...
      // TODO: use new Outpoint after upgrading bcoin.
      const proposal = await req.mswallet.getProposalByOutpoint({
        hash,
        index
      });
