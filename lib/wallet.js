...
class MultisigWallet extends EventEmitter {
  ...
  getJSON(unsafe, balance, stats, cosignerIndex = -1) {
    const cosigners = [];
    ...
    return {
      ...
      cosigners: cosigners,
      proposalStats: proposalStats.toJSON()
    };
  }

  toJSON(unsafe, balance, stats, cosignerIndex) {
    return this.getJSON(unsafe, balance, stats, cosignerIndex);
  }
